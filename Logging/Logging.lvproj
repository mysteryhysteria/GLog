		...
		<Item Name="tests" Type="Folder">
			...
			<Item Name="filters" Type="Folder">
				...
				<Item Name="regex" Type="Folder">
					<Item Name="Regex Test.vi" Type="VI" URL="../tests/filters/regex/Regex Test.vi"/>
				</Item>
				<Item Name="combination" Type="Folder">
					<Item Name="Combination Test.vi" Type="VI" URL="../tests/filters/data item/Combination Test.vi"/>
				</Item>
